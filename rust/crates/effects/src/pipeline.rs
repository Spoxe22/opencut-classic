...
const SUPER8_FRAME_SHADER_ID: &str = "super8-frame";
const SUPER8_FRAME_SHADER_SOURCE: &str = include_str!("shaders/super8_frame.wgsl");
...
impl EffectPipeline {
    pub fn new(context: &GpuContext) -> Self {
        ...
        let super8_frame_shader_module =
            context
                .device()
                .create_shader_module(wgpu::ShaderModuleDescriptor {
                    label: Some("effects-super8-frame-shader"),
                    source: wgpu::ShaderSource::Wgsl(SUPER8_FRAME_SHADER_SOURCE.into()),
                });
        let pipeline_layout =
            context
                .device()
        ...
        let super8_frame_pipeline =
            context
                .device()
                .create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                    label: Some("effects-super8-frame-pipeline"),
                    layout: Some(&pipeline_layout),
                    vertex: wgpu::VertexState {
                        module: &vertex_shader_module,
                        entry_point: Some("vertex_main"),
                    ...
                    fragment: Some(wgpu::FragmentState {
                        module: &super8_frame_shader_module,
                        entry_point: Some("fragment_main"),
                        targets: &[Some(wgpu::ColorTargetState {
                            format: context.texture_format(),
                            blend: None,
        ...
        let pipelines = HashMap::from([
            ...
            (SUPER8_FRAME_SHADER_ID.to_string(), super8_frame_pipeline),
        ]);
...
fn pack_effect_uniforms(
    ...
    if shader == SUPER8_FRAME_SHADER_ID {
        let grain = read_number_uniform(pass, "u_grain")?;
        ...
        return Ok(EffectUniformBuffer {
            ...
            direction: [0.0; 2],
            scalars: [grain, vignette, warmth, frame],
        });
    }
